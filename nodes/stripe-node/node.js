/**
 * ANC-MCP NODE — Main Entry Point (Stripe)
 * 
...
// NOTE: Do NOT add express.json() globally for Stripe — it needs raw body for sig verification.
// The handler itself will add the body parser with rawBody capture.
const app = express();
